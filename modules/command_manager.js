...
//1106399617635061810
          const hasRole = roles.some(role => role.name === '1106399617635061810')
...
if (error instanceof CommandError) source.sendError(error._message)
        ...
        else source.sendError({ translate: 'command.failed', hoverEvent: { action: 'show_text', contents: String(error.stack) } })
      }
    },
//
