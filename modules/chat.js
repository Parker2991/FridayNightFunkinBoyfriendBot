...
function inject (bot) {
  ...
  bot.chatParsers = [kaboomChatParser, chipmunkmodChatParser, chipmunkmodblackilykatverChatParser]
...
//chat.type.emote
  ...
  bot.on('packet.player_chat', packet => {
    ...
    tryParsingMessage(unsigned, { senderUuid: packet.senderUuid, players: bot.players, getMessageAsPrismarine: bot.getMessageAsPrismarine, chatType: vanillakeys})
