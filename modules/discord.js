...
function inject (bot, options) {
 ...
 bot.discord.channel.send(`\`\`\`\nSuccessfully logged into discord as ${bot.discord.client.user.username}#${bot.discord.client.user.discriminator}\n\`\`\``)
    console.log(`Successfully logged into discord as ${bot.discord.client.user.username}#${bot.discord.client.user.discriminator}`)
  })
...
bot.on('error', (error) => {
       ...
       sendDiscordMessage(`Disconnected: ${util.inspect(error.stack)}`)
