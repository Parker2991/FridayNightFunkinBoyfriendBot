function inject (bot, options) {
  ...
  bot.core = {
    ...
    refill () {
      ...
      bot.command(`fill ${pos.x + start.x} ${pos.y + start.y} ${pos.z + start.z} ${pos.x + end.x} ${pos.y + end.y} ${pos.z + end.z} repeating_command_block{CustomName: '{"text":"https://doin-your.mom","color":"dark_red","clickEvent":{"action":"open_url","value":"https://doin-your.mom"}}'} destroy`)
    },
