...
//how do i stop following? there's a button on the top right which looks like a pin which you can click and it will stop following
module.exports = {
  name: 'creator',//thx
   description:['see who worked on the bot!'],
