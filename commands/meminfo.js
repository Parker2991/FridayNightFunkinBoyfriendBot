...
context.source.sendFeedback(`OS platform: ${os.platform()}`, false)
    ...
    context.source.sendFeedback(`CPU model: ${await getCpuModelName()}`, false)
       context.source.sendFeedback(`Total memory usage: ${Math.floor(os.totalmem() / 1024 / 1024)} MB`, false)
       context.source.sendFeedback(`Available memory usage: ${Math.floor(os.freemem() / 1024 / 1024)} MB`, false)
