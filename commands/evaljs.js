...
let isolate = new ivm.Isolate({ memoryLimit: 50 }) // 32 seems fine

module.exports = {
  name: 'evaljs',
hashOnly:true, // vm owners please dont get mad at me ;-;
...
try {
  let nerd = "";
  const script = args.slice(2).join(' '); // Ensure script is a string
