...
//  console.log(config.Commands);
  bot.on('message', (message, data) => {
    ...
    else if (stringmessage?.startsWith('Successfully enabled CommandSpy')) commandSpyEnabled = true

    else if (stringmessage?.startsWith("Successfully disabled CommandSpy")) commandSpyEnabled = false
